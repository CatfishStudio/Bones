package bones.thousand 
{
	 ...
	 */
	public class ThousandEndGame extends Sprite 
	{
		...
		public function ThousandEndGame() 
		{
			super();
		...
		private function onAddedToStage(e:Event):void 
		{
			...
			name = Constants.THOUSAND_END_GAME;
			createQuad();
			createBackground();
			createRating();
			createButtons();
		...
		private function createButtons():void
		{
			...
			button.name = Constants.THOUSAND_END_GAME_BUTTON_RESTART_GAME;
			...
			button = new Button(Texture.fromBitmap(bitmap));
			button.name = Constants.THOUSAND_END_GAME_BUTTON_BACK_MENU;
