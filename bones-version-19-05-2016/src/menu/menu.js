...
var MenuState = (function (_super) {
    ...
    MenuState.prototype.windowRatingCreate = function () {
        ...
        this.windowRating.addChild(text);
        var ratingSevens = [
            ["Доктор Ливси", 700, "очков"],
            ["Бенджамин Ганн", 650, "очков"],
            ["Билли Бонс", 600, "очков"],
            ["Сквайер Трелони", 550, "очков"],
            ["Капитан Флинт", 500, "очков"],
            ["Джон Сильвер", 450, "очков"],
            ["Джим Хокинс", 400, "очков"],
            ["Израэль Хэндс", 350, "очков"],
            ["Капитан Смоллетт", 300, "очков"]
        ];
        n = 0;
        userWentUp = false;
