...
var PreloaderState = (function (_super) {
    ...
    PreloaderState.prototype.create = function () {
        ...
        this.load.image('preloader', './assets/textures/1a.png');
    ...
    PreloaderState.prototype.onFileComplete = function (progress, cacheKey, success, totalLoaded, totalFiles) {
        ...
        if (cacheKey === "preloader") {
            ...
            this.progressText = this.game.add.text(340, 550, "ЗАГРУЗКА 0%", { font: "25px Monotype Corsiva", fill: "#FFFFAA", align: "center" });
        }
